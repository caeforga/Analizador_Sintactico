...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void analizarLexico() throws IOException{
        ...
        while (true) {
            ...
            switch (token) {
                case Cadena:
                    resultado += "  <td cadena>\t" + lexer.lexeme + "\n";
                    break;
                case T_dato:
                ...
                case Mientras:
                    ...
                    break;
                case FinMientras:
                    resultado += "  <Reservada FinMientras>\t" + lexer.lexeme + "\n";
                    break;
                case Para:
                ...
                case Op_rel:
                    ...
                    break;
                case FinSi:
                    resultado += "  <Reservada FinSi>\t" + lexer.lexeme + "\n";
                    break;
                case Escribir:
                    resultado += "  <Escribir>\t" + lexer.lexeme + "\n";
                    break;
                case Leer:
                    resultado += "  <Leer>\t" + lexer.lexeme + "\n";
                    break;
                case Hasta:
                ...
                case Entonces:
                    ...
                    break;
                case FinPrograma:
                    resultado += "  <Fin Programa>\t" + lexer.lexeme + "\n";
                    break;
                case P_izq:
                ...
                case P_der:
                    ...
                    break;
                case FinPara:
                    resultado += "  <Reservada Fin Para>\t" + lexer.lexeme + "\n";
                    break;
                case Programa:
                    resultado += "  <inicio programa>\t" + lexer.lexeme + "\n";
                    break;
                case Op_lo:
                    resultado += "  <operador lógico>\t" + lexer.lexeme + "\n";
                    break;
    ...
    private void btnAnalizarSinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarSinActionPerformed
        ...
        sintax s = new sintax(new analizadorSin.LexerCup(new StringReader(ST)));
